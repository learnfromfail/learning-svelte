    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			div1.innerHTML = `<h3>HowTo</h3> 
    <div bp="grid"><img bp="offset-5@md 4@md 12@sm" src="pika.jpg" alt="" class="svelte-wwxt9"/></div>`;

    			attr(div1, "class", "border-hint");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			span = element("span");
    			t2 = text("%");
    			t3 = text(/*progress*/ ctx[0]);
    			attr(span, "class", "sr-only");
    			attr(div0, "class", "progress-bar svelte-19rlolu");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-19rlolu");
    			attr(div2, "bp", "grid");
    			attr(div3, "class", "border-hint");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*progress*/ 1) set_data(t3, /*progress*/ ctx[0]);
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div2 = element("div");
    			h3 = element("h3");
    			h3.textContent = "Timmer";
    			t1 = space();
    			div0 = element("div");
    			h2 = element("h2");
    			t2 = text("Second Left:");
    			t3 = text(/*secondLeft*/ ctx[0]);
    			t4 = text(", ");
    			t5 = text(/*progress*/ ctx[2]);
    			t6 = space();
    			...
    			attr(h2, "class", "svelte-2kao0n");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "bp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "start svelte-2kao0n");
    			attr(div1, "bp", "grid");
    			attr(div2, "class", "border-hint");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			if (!current || dirty & /*secondLeft*/ 1) set_data(t3, /*secondLeft*/ ctx[0]);
    			if (!current || dirty & /*progress*/ 4) set_data(t5, /*progress*/ ctx[2]);
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			audio_1.innerHTML = `<source src="pikapika.mp3"/>`;
    			attr(h1, "class", "svelte-1p8nrvw");
    		},
    		m(target, anchor) {
